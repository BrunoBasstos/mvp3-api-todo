...
class Tarefa(Base):
    ...
    data_tarefa = Column(DateTime, default=datetime.now(), nullable=True)
    ...
    def __init__(self, titulo: str, descricao: str, status: Status, prioridade: Prioridade,
                 data_tarefa: Union[datetime, None], cidade: Union[str, None], usuario_id: int,
        ...
        Arguments:
            ...
            data_tarefa: a data de uma tarefa.
            cidade: a cidade de uma tarefa.
    ...
    def to_dict(self):
        return {
            ...
            "data_tarefa": self.data_tarefa.isoformat() if self.data_tarefa is not None else None,
            "cidade": self.cidade,
